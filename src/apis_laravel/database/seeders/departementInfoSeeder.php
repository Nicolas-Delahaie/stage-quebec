...
class departementInfoSeeder extends Seeder
{
    ...
    public function run(): void
    {
        ...
        // DEPARTEMENT
        $deptInfo = Departement::create(["nom" => "Informatique", "nb_eleves" => 100, "coordonnateur_id" => null]);
        ...
        // ALOUER
        $alouer = [
            ["temps_aloue" => 0.355, "annee" => 2023, "semestre" => 1, "utilisateur_id" => 7, "liberation_id" => 2],
            ["temps_aloue" => 0.100, "annee" => 2023, "semestre" => 1, "utilisateur_id" => 7, "liberation_id" => 3],
            ["temps_aloue" => 0.205, "annee" => 2023, "semestre" => 1, "utilisateur_id" => 7, "liberation_id" => 4],
            ["temps_aloue" => 0.050, "annee" => 2023, "semestre" => 1, "utilisateur_id" => 4, "liberation_id" => 5],
            ["temps_aloue" => 0.050, "annee" => 2023, "semestre" => 1, "utilisateur_id" => 9, "liberation_id" => 5],
            ["temps_aloue" => 0.255, "annee" => 2023, "semestre" => 1, "utilisateur_id" => 3, "liberation_id" => 6],
            ["temps_aloue" => 0.100, "annee" => 2023, "semestre" => 1, "utilisateur_id" => 2, "liberation_id" => 7],
        ];
