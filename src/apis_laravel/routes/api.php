...
Route::get('scenarios', [ScenarioController::class, 'index'])->middleware(['tokenBon', 'responsable']);
Route::get('scenarios/{id}', [ScenarioController::class, 'show'])->middleware(['tokenBon', 'responsable']);
Route::get('scenarios/{id}/detaille', [ScenarioController::class, 'showDetails'])->middleware(['tokenBon', 'responsable']);
Route::get('scenarios/{id}/departement', [ScenarioController::class, 'showDepartement'])->middleware(['tokenBon', 'responsable']);
Route::get('scenarios/{id}/proprietaire', [ScenarioController::class, 'showProprietaire'])->middleware(['tokenBon', 'responsable']);
Route::get('scenarios/{id}/rdvs', [ScenarioController::class, 'showRDVs'])->middleware(['tokenBon', 'responsable']);
Route::get('scenarios/{id}/modifications', [ScenarioController::class, 'showModifications'])->middleware(['tokenBon', 'responsable']);
